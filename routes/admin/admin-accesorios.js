...
router
    ...
    .post(
        ...
        [
            ...
            check("price", "la cantidad debe ser un numero").isNumeric(),
        ...
        async (req, res, next) => {
            try {
                ...
                const { type, price, cnt = 1, description = undefined, ownerPhone, ownerName, ownerAccount } = req.body;
...
router
    ...
    .delete([check("id").isMongoId()], async (req, res, next) => {
        ...
        try {
            ...
            const orders = await Order.find({ type: "accesorie", accesorie: id }).populate("user").exec();
