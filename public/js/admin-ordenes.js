const petsTables = document.querySelectorAll(".pets-table"),
  ...
  articlesTablesBody = document.querySelectorAll(
    ".articles-table .main-table__body"
  ),
...
function updateState(form) {
  ...
  const userStateData = { state: inputRadio.value };
  ...
  fetch(url, {
    ...
    body: JSON.stringify(userStateData),
