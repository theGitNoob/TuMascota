...
function addModalConfirmEmail() {
    ...
    modalLogin.innerHTML =
        "                <div class='modal confirm-login'><div class='modal__header'>Confirmar Cuenta<button type='submit' class='modal-close'><img class='modal-close__icon' src='public/img/res/close-white.webp' alt=''/></button></div><div class='modal__body'> <h4>Hola Jmlopez</h4> <img src='public/img/login/email-warning.webp' alt='' /><span>Aún no ha confirmado su cuenta en su correo electrónico.</span></div><div class='modal-line-login line-login'>si no le ha llegado el correo a su buzón, presione aquí <a href='users/send_email'>reenviar correo</a></div></div>";
